...
use App\Events\Application\UpdateEvent\UpdateEvent;
use App\Events\Application\UpdateEvent\UpdateEventHandler;
...
final class EventsController
{
    ...
    #[Route(path: '/events/{id}', name: 'events_update', methods: ['PUT'])]
    #[OA\Put(path: '/events/{id}', summary: 'Update event by ID')]
    #[OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'string', format: 'uuid'))]
    #[OA\RequestBody(required: true, content: new OA\JsonContent(required: ['name','startAt','endAt'], properties: [
        new OA\Property(property: 'name', type: 'string'),
        new OA\Property(property: 'startAt', type: 'string', format: 'date-time'),
        new OA\Property(property: 'endAt', type: 'string', format: 'date-time'),
    ], type: 'object'))]
    #[OA\Response(response: 200, description: 'Event updated', content: new OA\JsonContent(properties: [
        new OA\Property(property: 'id', type: 'string', format: 'uuid'),
        new OA\Property(property: 'name', type: 'string'),
        new OA\Property(property: 'organiserId', type: 'string', format: 'uuid'),
        new OA\Property(property: 'startAt', type: 'string', format: 'date-time'),
